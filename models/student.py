...
class Student(Person):
    ...
    @staticmethod
    def find_list_by_course(course):
        list_by_course = []
        counter = 0
        for student in students.list_of_instance:
    ...
    def get_by_alphabet_on_faculty(faculty):
        list_by_alphabet = []
        list_by_faculty = Student.find_list_by_faculty(faculty)
    ...
    @staticmethod
    def get_by_cathedra_s_course(cathedra):
        sorted_list = []
        list_by_course = Student.get_by_course()
        list_by_cathedra = Student.find_list_by_cathedra(cathedra)
    ...
    def get_by_cathedra_by_alphabet(cathedra):
        sorted_list = []
        list_by_alphabet = Student.get_by_alphabet()
        list_by_cathedra = Student.find_list_by_cathedra(cathedra)
        for student in list_by_cathedra:
    ...
    @staticmethod
    def get_students_cathedra_course(cathedra, course):
        list_by_course = Student.find_list_by_course(course)
        list_by_cathedra = Student.find_list_by_cathedra(cathedra)
        sorted_list = []
    ...
    @staticmethod
    def get_students_course_cathedra_alphabet(course, cathedra):
        list_cathedra_course = Student.get_students_cathedra_course(cathedra, course)
        sorted_list = []
        for letter in alphabet:
